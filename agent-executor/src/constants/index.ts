...
const PROTOCOL_METADATA: Record<string, ProtocolMetadata> = {
  ...
  openocean: {
    ...
    tools: [
      {
        name: "openocean_get_tokens",
        shortDesc: "Get list of available tokens",
        longDesc: "OpenOcean is a DEX aggregator. This tool fetches all available tokens on Mantle with their addresses, symbols, names and decimals.",
      },
      {
