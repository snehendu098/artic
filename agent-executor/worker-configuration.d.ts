/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: dd6cc20929a9dfdf16f2834c83d4cf8a)
// Runtime types generated with workerd@1.20260107.1 2025-12-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentExecutorDO";
	}
	interface Env {
		EVENTS: KVNamespace;
		GROQ_API_KEY: string;
		...
		ACCOUNT_ID: string;
		GATEWAY_NAME: string;
		AGENT_EXECUTOR: DurableObjectNamespace<import("./src/index").AgentExecutorDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GROQ_API_KEY" | "DB_LAYER_URL" | "ACCOUNT_ID" | "GATEWAY_NAME">> {}
}
