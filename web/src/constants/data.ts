...
// Note: Some subscriptions match user-created strategies (for testing detail pages)
export const dummySubscriptions: Subscription[] = [
  {
    id: "1",
    strategyName: "ETH Yield Maximizer",
    strategyCreator: "@self",
    amountInvested: 5000,
    currentValue: 5420,
    apy: 8.5,
...
export const dummyActions: Action[] = [
  {
    id: "1",
    type: "execution",
    description: "Main Delegation Wallet: ETH Yield Maximizer executed swap on Uniswap",
    amount: 2.5,
  ...
  },
  {
    id: "3",
    type: "execution",
    description: "Main Delegation Wallet: Staked 1.2 ETH on Rocket Pool",
    amount: 1.2,
  ...
  },
  {
    id: "5",
    type: "execution",
    description: "Main Delegation Wallet: Provided liquidity to USDC/USDT pool on Curve",
    amount: 2500,
  ...
  },
  {
    id: "7",
    type: "execution",
    description: "DeFi Strategy Wallet: Stable Coin Arbitrage rebalanced portfolio",
  ...
  },
  {
    id: "8",
    type: "execution",
    description: "DeFi Strategy Wallet: Swapped 1000 USDC for ARB on Balancer",
    amount: 1000,
  ...
  },
  {
    id: "9",
    type: "execution",
    description: "Yield Optimizer Wallet: Added liquidity to OP pool",
    amount: 800,
  ...
  },
  {
    id: "11",
    type: "execution",
    description: "Yield Optimizer Wallet: Multi-Chain Liquidity Provider executed cross-chain swap",
    amount: 0.5,
  ...
  },
  {
    id: "12",
    type: "execution",
    description: "Trading Wallet: Smart DCA purchased 0.2 ETH on 1inch",
    amount: 0.2,
  ...
  },
  {
    id: "14",
    type: "execution",
    description: "Trading Wallet: Automated buy order filled at target price",
    amount: 1.1,
  ...
  },
  {
    id: "16",
    type: "execution",
    description: "Long Term Holdings: Delegated voting power for BNB governance",
  ...
  },
  {
    id: "18",
    type: "execution",
    description: "Main Delegation Wallet: Claimed 0.15 ETH rewards from Lido",
    amount: 0.15,
